...
#define gEmbeddedNNUEData gEmbeddedNNUEUltraLiteData
#define gEmbeddedNNUESize gEmbeddedNNUEUltraLiteSize
#elif defined(__LITE_NET__)
#include "../emscripten/wasm_embedded_lite_network.h"
#define gEmbeddedNNUEData gEmbeddedNNUELiteData
#define gEmbeddedNNUESize gEmbeddedNNUELiteSize
#else
#include "../emscripten/wasm_embedded_networks.h"
#define gEmbeddedNNUEData gEmbeddedNNUEBigData
#define gEmbeddedNNUESize gEmbeddedNNUEBigSize
#endif
